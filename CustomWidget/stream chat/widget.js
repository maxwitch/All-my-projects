...
window.addEventListener('onEventReceived', function (obj) {
                    ...
                    listener: "message", event: {
                        ...
                        data: {
                            ...
                            badges: [{
                                type: "moderator",
                                version: "1",
                                url: "https://i.postimg.cc/VJLHpphw/moder.png",
                                description: "Moderator"
                            }, {
                                type: "partner",
                                version: "1",
                                url: "https://i.postimg.cc/svJNnswK/vip.png",
    ...
    for (let i = 0; i < data.badges.length; i++) {
        ...
        if (badge.type === "broadcaster") {
            badge.url = 'https://i.postimg.cc/9r2ktrtr/cam.png'
            
        } else if (badge.type === "moderator") {
                badge.url = 'https://i.postimg.cc/VJLHpphw/moder.png'
            
        } else if (badge.type === "subscriber") {
                badge.url = 'https://i.postimg.cc/svJNnswK/vip.png'
        }
...
function addMessage(username, badges, message, isAction, uid, msgId) {
    ...
    <div data-sender="${uid}" data-msgid="${msgId}" class="message-row {animationIn} animated" id="msg-${totalMessages}">
        <div class="user-box ${actionClass}"><p>${username}</p><span class='span-badges'>${badges}</span></div><img src='https://i.postimg.cc/7ZXFqLYN/flower.png' class='flower-img'>
        <div class = 'div-for-borderflower'><div class="user-message ${actionClass}"><p>${message}</p></div></div>
    </div>`);
    if (addition === "append") {
        if (hideAfter !== 999) {
